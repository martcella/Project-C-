...
int main() {
	...
	int jum_beli, bayar,diskon,jumlah[10], harga[10], sub_tot[10];
	...
	cout<<"---------------------------------------------------------"<<endl;
	cout<<"Barang    Jumlah     Harga     Sub Total"<<endl;
	for (int i=0;i<jum_beli;i++){
		cout<<nama_barang[i]<<setw(10)<<jumlah[i]<<setw(12)<<harga[i]<<setw(12)<<sub_tot[i]<<endl; //Menampilkan semua nilai array
	}
	cout<<"---------------------------------------------------------"<<endl;
